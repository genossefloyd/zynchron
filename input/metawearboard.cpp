...
void metawearboard::readCharacteristic(QLowEnergyCharacteristic gatt,QByteArray value)
{
...
void metawearboard::updateCharacteristic(QLowEnergyCharacteristic gatt, QByteArray value)
{
