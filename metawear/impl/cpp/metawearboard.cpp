...
#include "core/cpp/datasignal_private.h"
#include "core/cpp/event_register.h"
#include "core/cpp/logging_register.h"
#include "core/cpp/logging_private.h"
#include "core/cpp/metawearboard_def.h"
#include "core/cpp/register.h"
#include "core/cpp/responseheader.h"
#include "core/cpp/settings_register.h"
#include "core/cpp/settings_private.h"
#include "core/cpp/timer_private.h"

#include "platform/cpp/threadpool.h"

#include "processor/cpp/dataprocessor_register.h"
#include "processor/cpp/dataprocessor_private.h"

#include "sensor/cpp/accelerometer_private.h"
#include "sensor/cpp/ambientlight_ltr329_private.h"
#include "sensor/cpp/barometer_bosch_private.h"
#include "sensor/cpp/colordetector_tcs34725_private.h"
#include "sensor/cpp/gpio_private.h"
#include "sensor/cpp/gpio_register.h"
#include "sensor/cpp/gyro_bmi160_private.h"
#include "sensor/cpp/humidity_bme280_private.h"
#include "sensor/cpp/magnetometer_bmm150_private.h"
#include "sensor/cpp/multichanneltemperature_private.h"
#include "sensor/cpp/proximity_tsl2671_private.h"
#include "sensor/cpp/serialpassthrough_private.h"
#include "sensor/cpp/serialpassthrough_register.h"
#include "sensor/cpp/switch_private.h"
...
void mbl_mw_metawearboard_char_read(MblMwMetaWearBoard *board, const MblMwGattChar *characteristic, const uint8_t *value, uint8_t length) {
	if(board == NULL || characteristic == NULL || value == NULL)
	{
		return;
	}
